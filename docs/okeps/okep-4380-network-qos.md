...
In the same diagram above, I want external traffic towards Internet from Pod1 to not exceed
...
This creates a new AddressSet adding default namespace pod(s) IP associated with ovn-stream
