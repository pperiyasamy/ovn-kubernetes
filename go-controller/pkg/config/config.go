...
var (
	...
	OVNKubernetesFeature = OVNKubernetesFeatureConfig{
		...
		UDNIsolationMode:                UDNIsolationModeStrict,
	}
...
type OVNKubernetesFeatureConfig struct {
	...
	UDNIsolationMode string `gcfg:"advertised-udn-isolation-mode"`
}
...
const (
	// UDNIsolationModeStrict pod isolation across advertised UDN networks is enabled.
	UDNIsolationModeStrict = "strict"
	// UDNIsolationModeLoose pod isolation across advertised UDN networks is disabled.
	UDNIsolationModeLoose = "loose"
)
...
var OVNK8sFeatureFlags = []cli.Flag{
	...
	&cli.StringFlag{
		...
		Destination: &cliConfig.OVNKubernetesFeature.UDNIsolationMode,
		Value:       OVNKubernetesFeature.UDNIsolationMode,
	},
	&cli.BoolFlag{
...
func buildOVNKubernetesFeatureConfig(cli, file *config) error {
	...
	if OVNKubernetesFeature.UDNIsolationMode != UDNIsolationModeStrict && OVNKubernetesFeature.UDNIsolationMode != UDNIsolationModeLoose {
		return fmt.Errorf("invalid advertised-udn-isolation-mode %q: expect one of %s or %s",
			OVNKubernetesFeature.UDNIsolationMode, UDNIsolationModeStrict, UDNIsolationModeLoose)
	}
	return nil
}
