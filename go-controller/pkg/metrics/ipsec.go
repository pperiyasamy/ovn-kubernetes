...
func listEstablishedIPsecTunnels(ipsec ipsecClient) (sets.Set[string], error) {
	...
	// The `ipsec showstates` command is currently treated as the reliable
	// source of truth for determining established IPsec tunnels. This can
	// be revisited if a more optimal approach is identified.
